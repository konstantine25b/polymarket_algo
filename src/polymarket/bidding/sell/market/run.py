#!/usr/bin/env python3
"""
Command-line script for executing Polymarket market sell orders.
"""
...
from src.polymarket.bidding.sell.market import MarketSellOrder

def run_market_sell(token_id, amount):
    """
    Execute a market sell order with the given token ID and amount.
...
def main():
    ...
    if len(sys.argv) < 3:
        print("Usage: python -m src.polymarket.bidding.sell.market.run <token_id> <amount>")
        sys.exit(1)
